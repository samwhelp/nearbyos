...
mod_package_list_build () {
	...
	cat "${THE_PACKAGE_COMMON_MAIN_DIR_PATH}/input-method.txt" >> "${package_list_file_path}"
	...
	cat "${THE_PACKAGE_COMMON_MODELING_DIR_PATH}/display-manager/lightdm.txt" >> "${package_list_file_path}"
